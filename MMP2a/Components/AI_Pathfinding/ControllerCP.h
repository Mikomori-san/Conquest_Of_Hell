...
{
public:
	ControllerCP(std::weak_ptr<GameObject> gameObject, std::string id, std::vector<std::shared_ptr<GameObject>> incPlayers) : Component(gameObject, id), players(incPlayers) { health = 0; maxHealth = 0; };
