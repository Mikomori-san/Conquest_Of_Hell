...
public:
	...
	StatsCP(std::weak_ptr<GameObject> gameObject, std::string id, int hp, int dmg, std::string incObjType) : Component(gameObject, id), health(hp), gameObjectType(incObjType), damage(dmg) {};
